...
private fun Project.startParameterProperties(key: String): Provider<String> {
    val provider =
        project.rootProject.getOrCreateExtra("scaler.properties.provider.start-properties") {
...
internal fun Project.localProperty(key: String): Provider<String> {
    return localPropertiesProvider(key, "scaler.properties.provider.local-properties") {
...
internal fun Project.localGradleProperty(key: String): Provider<String> {
    return localPropertiesProvider(key, "scaler.properties.provider.local-gradle-properties") {
        parameters.propertiesFile.setDisallowChanges(
